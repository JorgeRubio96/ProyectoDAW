...
public class subjectServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<ui>");
            while ( myResult.next()) {
                String codigo = myResult.getString("code");
                String nom = myResult.getString("title");
                String honors = myResult.getBoolean("honors")?
                                "Honors":"Normal";
                out.println("<li>");
                out.println(nom+"  ("+codigo+")  "+honors+"</li>");
            }
            out.println("<li>Hola</li>");
            out.println("</ui>");
            /*out.println("</body>");
            out.println("</html>");*/
        }
